...
### For Modders
- Download the **`bundle`** from the [latest release](https://github.com/Zenith-Team/Zap/releases/latest) and extract it to your mod folder, merging the `content` and `code` folders into your project.
